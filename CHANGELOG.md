...
## [2.14.0](https://github.com/bustergreen-netizen/KunBox/compare/v2.13.4...v2.14.0) (2026-05-17)


### Features

* add ConfigRepository for managing SingBox configurations, profiles, and subscriptions. ([b435cd9](https://github.com/bustergreen-netizen/KunBox/commit/b435cd943d8ccb1de0dc55615f17eaea704b1a58))
* Add DashboardScreen and ViewModel for VPN connection management, statistics display, and profile/node selection. ([a54464d](https://github.com/bustergreen-netizen/KunBox/commit/a54464d0f812dc5af276437eb49c31ed2e6bd923))
* Add DashboardViewModel and UI screens for app groups, domain rules, and logs. ([1ec9993](https://github.com/bustergreen-netizen/KunBox/commit/1ec9993b4f1c528e55e18fe7727ef56ee1282e05))
* Add initial application structure, core UI for dashboard and node management, connection logic, and comprehensive settings with localization. ([a90a493](https://github.com/bustergreen-netizen/KunBox/commit/a90a49382da46e511ded8031ab3486ad07c8060e))
* add node line query diagnostics ([c14668b](https://github.com/bustergreen-netizen/KunBox/commit/c14668b1417bc9f47da7142e01c83f52a7b5ccd6))
* add NodeDetailScreen for managing Singbox node configurations. ([25da274](https://github.com/bustergreen-netizen/KunBox/commit/25da2749c1652ba299b9d5226417d490e0508549))
* add release-please workflow to auto-create release PRs ([43a0516](https://github.com/bustergreen-netizen/KunBox/commit/43a051623d0e07eb8507fd25c6efb08fa1be3e2c))
* align custom config node selection UI with rule sets node selection UI ([0f78055](https://github.com/bustergreen-netizen/KunBox/commit/0f78055caffe6954bfce0c6459a9e7a2119f42a7))
* **core:** add kernel-level hot reload for config changes ([c4732a3](https://github.com/bustergreen-netizen/KunBox/commit/c4732a37c5673c547c01970d2b5b37c2ab90133c))
* Implement `ConfigRepository` for profile and node management, alongside `EditableSettingItem` and `NodeDetailScreen` UI. ([876a1b1](https://github.com/bustergreen-netizen/KunBox/commit/876a1b1a44c159020916300c9ce38d652d5da71d))
* Implement initial SingBox client application with core VPN functionality, UI, and data management. ([1e6e439](https://github.com/bustergreen-netizen/KunBox/commit/1e6e4398d707d7b8a7db6231db6bafebefe3b25f))
* Implement initial SingBox integration with IPC, configuration fixing, latency probing, and dashboard UI. ([3c01657](https://github.com/bustergreen-netizen/KunBox/commit/3c0165766ef5f55316020ae269ba37e2fad7eb29))
* Implement the foundational SingBox application with its primary UI screens and core services. ([b6af8c5](https://github.com/bustergreen-netizen/KunBox/commit/b6af8c5e54eff03b4bc0a0ea8ca6358de85fcabd))
* improve node link parsing and latency test settings ([3bf90af](https://github.com/bustergreen-netizen/KunBox/commit/3bf90af0a7b0a420a2e51827e0293446ba38e51e))
* **inbound:** 为 mixed inbound 添加 reuse_addr 选项 ([a947148](https://github.com/bustergreen-netizen/KunBox/commit/a947148f8b580916b999273215573902c48bb512))
* Integrate SingBox core library and service, introducing a state-recording background power manager. ([aaeca96](https://github.com/bustergreen-netizen/KunBox/commit/aaeca9603dd2dddaaa284aba31b72f9423679948))
* introduce core SingBox integration, IPC, services, and initial dashboard UI with localization. ([af6b302](https://github.com/bustergreen-netizen/KunBox/commit/af6b302930032f6cdb97274b6d72b2f6cd763bf0))
* Introduce core SingBox services, managers, repositories, and a diagnostics view model for initial application setup. ([e6157ea](https://github.com/bustergreen-netizen/KunBox/commit/e6157ea0d00040e3052fab6c6478a46af314a2ee))
* **ipc:** improve VPN state management and add kernel build docs ([ce8d5e9](https://github.com/bustergreen-netizen/KunBox/commit/ce8d5e972f2602596f2a1c28c89b46a8beccab94))
* **kernel:** add kernel-level HTTP fetch and URLTest extensions ([fa6cd20](https://github.com/bustergreen-netizen/KunBox/commit/fa6cd20bc48f86b8a64b48da48185e073b621cf0))
* **latency:** persist node latency data and optimize libbox build ([316ed9b](https://github.com/bustergreen-netizen/KunBox/commit/316ed9b24f1ef98bb0a4e5bdcbcfc70c2623c0f0))
* **network:** add NetworkSwitchManager for WiFi/Cellular handoff ([a88a18f](https://github.com/bustergreen-netizen/KunBox/commit/a88a18fa0cd040b5b0d55d7c9b4385ca6cdc2610))
* **network:** 实现智能网络恢复机制解决后台切换卡顿问题 ([e7ef770](https://github.com/bustergreen-netizen/KunBox/commit/e7ef770f65721f30b87a37ec7a339cc9009d5516))
* **nodes:** add latency test progress bar with success/timeout stats ([7d333a3](https://github.com/bustergreen-netizen/KunBox/commit/7d333a332536fb59f999c511ae99263c6f768cdb))
* **nodes:** add profile selection for manual node creation ([4da7bef](https://github.com/bustergreen-netizen/KunBox/commit/4da7bef9ce9708ab0b4878ea8c7ebc525c6388d3))
* **nodes:** 优化搜索栏设计 ([1e3a2db](https://github.com/bustergreen-netizen/KunBox/commit/1e3a2dbb49c5682dc4c0e6d6b81ba03cd06d08da))
* **nodes:** 搜索栏跟随滚动显隐 ([dfda72a](https://github.com/bustergreen-netizen/KunBox/commit/dfda72a54ed1854e7f0af8223982de9f6a345916))
* **parser:** add Clash Meta advanced features support ([d60e3a2](https://github.com/bustergreen-netizen/KunBox/commit/d60e3a2639b73bcaef2ea9b6b74c4a2bded9be6a))
* **routing:** smart domain recognition + fix domain routing priority ([4014073](https://github.com/bustergreen-netizen/KunBox/commit/4014073ebc221ff0da0bfc1b793ea275e82d4e5c))
* **traffic:** 实现按 outbound 分组的流量统计 ([dc822cb](https://github.com/bustergreen-netizen/KunBox/commit/dc822cb6d5ade32a44db07b01dca9f4b4a983e1b))
* **traffic:** 新增流量统计页面，修复分流节点流量记录问题 ([9f687e1](https://github.com/bustergreen-netizen/KunBox/commit/9f687e18c38212bc165fe7e5f2407d8b306a82ab))
* **traffic:** 添加刷新按钮，支持手动刷新流量数据 ([96c4f0a](https://github.com/bustergreen-netizen/KunBox/commit/96c4f0a05ba579dcfd58eec4fb4f79d67d44e446))
* **ui:** improve navigation animations and add gengar floating effect ([6f8c214](https://github.com/bustergreen-netizen/KunBox/commit/6f8c214e4ef14d7a725e21e2f63d4d7a911a5268))
* **ui:** optimize app selector dialog layout and sort selected apps first ([35b9ea2](https://github.com/bustergreen-netizen/KunBox/commit/35b9ea26d335419f688eb069f09b5d684bc1a2d4))
* **ui:** sync node selector dialog state with nodes list ([624b1d0](https://github.com/bustergreen-netizen/KunBox/commit/624b1d0788950fb141e1211b04d01144177a2b11))
* update diagnostics and network recovery flows ([8c7c52b](https://github.com/bustergreen-netizen/KunBox/commit/8c7c52bc6dd44f50815fd955aba84272f52143ac))
* update workflow logic and dynamic versioning ([e76fbdf](https://github.com/bustergreen-netizen/KunBox/commit/e76fbdfa5d19963a87ce312da5bdace6031dbc64))
* **update:** implement app version check and notification ([ee5ee2f](https://github.com/bustergreen-netizen/KunBox/commit/ee5ee2f8d2c56ce27d4abe684aee04cfdc45113b))
* 内核更新 ([36cd825](https://github.com/bustergreen-netizen/KunBox/commit/36cd82527d58defcf712fcb97f847b83cd4ea2c3))


### Bug Fixes

* ：JSON 格式不标准 (Gson 解析异常) ([a9f2c86](https://github.com/bustergreen-netizen/KunBox/commit/a9f2c8621408523b3df34266b376aa5b4b9c9303))
* ? ([57a84d7](https://github.com/bustergreen-netizen/KunBox/commit/57a84d73670733961c794000925d7d29ece33cfe))
* . ([ab7659a](https://github.com/bustergreen-netizen/KunBox/commit/ab7659a9b3cffd1c22afed480f8f80d34fbd4ec0))
* . ([46ae75e](https://github.com/bustergreen-netizen/KunBox/commit/46ae75e79e52c8a39f6e897403d234a57115973e))
* . ([f7942af](https://github.com/bustergreen-netizen/KunBox/commit/f7942aff183801fe79583093a672cfc238ee5105))
* ... ([fc3ef4c](https://github.com/bustergreen-netizen/KunBox/commit/fc3ef4c11b4c41d9a8e90cb595bf7e0be2693bdf))
* .... ([d011867](https://github.com/bustergreen-netizen/KunBox/commit/d011867ad1357493e64159a8256d87798fe2917f))
* 000 ([03db480](https://github.com/bustergreen-netizen/KunBox/commit/03db4805b99676ffab95396576e44aa6de6b9112))
* 2 ([795f2ec](https://github.com/bustergreen-netizen/KunBox/commit/795f2ec3a768c516bef42a71069ad92f4b85f628))
* add automatic failover for stalled proxy traffic ([a9d6935](https://github.com/bustergreen-netizen/KunBox/commit/a9d69352a48c0d9c570b38969172c98d4df87119))
* add ConfigRepository for managing application configurations, profiles, and network-related settings. ([b4c5909](https://github.com/bustergreen-netizen/KunBox/commit/b4c59092f23885e229baca448f6fbeb6a5b3edf9))
* Add English;随便修了一些bug ([f0a12ff](https://github.com/bustergreen-netizen/KunBox/commit/f0a12ff70727ecaaec5c1f2d354255b0b3623751))
* Add node and profile management screens, view models, and Libbox compatibility layer with supporting utilities. ([5d7ff2b](https://github.com/bustergreen-netizen/KunBox/commit/5d7ff2b9c22c8f584f1e62e3109cca1e18514863))
* Add NodesViewModel for managing node display logic, filtering, sorting, and latency testing. ([3a2ae4c](https://github.com/bustergreen-netizen/KunBox/commit/3a2ae4c9e5d288c2c7804ee4960f603063e3ac78))
* bug ([cb5f10a](https://github.com/bustergreen-netizen/KunBox/commit/cb5f10aaa95771d0e47b3289797654b30e64ed87))
* bug fix ([e480d99](https://github.com/bustergreen-netizen/KunBox/commit/e480d99d0f9103d6a26321508b6992117337a891))
* bug修复 ([f6ab50f](https://github.com/bustergreen-netizen/KunBox/commit/f6ab50f1f5d610507122213d6af08edba1309234))
* **ci:** merge build into release-please workflow ([9845fda](https://github.com/bustergreen-netizen/KunBox/commit/9845fdaac2d0ef089bad73533be87c5586feedf6))
* **ci:** separate release-please and build workflows ([d879764](https://github.com/bustergreen-netizen/KunBox/commit/d879764566791477d43d6809d815a71279b5a7ff))
* clear ipc hub binder stale state ([8a5e242](https://github.com/bustergreen-netizen/KunBox/commit/8a5e24254b2fa5acc72281db21c78f5217957ee0))
* clear stale vpn runtime state ([54607e8](https://github.com/bustergreen-netizen/KunBox/commit/54607e85e44885b17197687cb1150ddca19a41cb))
* **config:** node state persistence and profile node memory ([a34bab3](https://github.com/bustergreen-netizen/KunBox/commit/a34bab312758b6c324c518441c2f4c3cedd0c9c7))
* **core:** 修复 VPN 服务因 bbolt 数据库并发冲突导致自动停止的 bug ([ac301f7](https://github.com/bustergreen-netizen/KunBox/commit/ac301f7df98f35c1e6596f895f04d2e2a88b65bf))
* **core:** 彻底修复 bbolt panic - 根本原因是多进程并发访问同一数据库 ([42ba8cf](https://github.com/bustergreen-netizen/KunBox/commit/42ba8cf0018dda3f9e02e8702e8971f4ee75ac86))
* **core:** 确保测试数据库目录存在 - 添加 mkdirs() 调用 ([d57838d](https://github.com/bustergreen-netizen/KunBox/commit/d57838d98dca559ec49f06eaad68e6db03c82764))
* **data:** persist node latency and improve update check ([a017357](https://github.com/bustergreen-netizen/KunBox/commit/a017357603793546c4a54462d236f6fd9ea282a8))
* **db:** remove foreign key constraint to fix node latency persistence ([905b07e](https://github.com/bustergreen-netizen/KunBox/commit/905b07e10782d4d12c68f98db6c799ed3643ff59))
* **detekt:** 修复所有 detekt 静态分析问题 ([8976225](https://github.com/bustergreen-netizen/KunBox/commit/89762250339bcfaf7b2e8855d8d46e1ffbd61f81))
* **dns:** 使用竞速模式优化 DNS 解析速度 ([285f7f1](https://github.com/bustergreen-netizen/KunBox/commit/285f7f19baf9d2f279035dd4af8932c893be125a))
* ECH DNS规则改用直连避免loopback循环依赖 ([67bf416](https://github.com/bustergreen-netizen/KunBox/commit/67bf4167a82bb95e55fb380e4b647a7e3c72a3fd))
* ECH场景DNS无detour导致污染 + 日志功能增强 ([9613a09](https://github.com/bustergreen-netizen/KunBox/commit/9613a09a6b179f6198a76c2eb20158ee0bdd6a04))
* **filter:** preserve filter keywords when switching filter modes ([e21efa8](https://github.com/bustergreen-netizen/KunBox/commit/e21efa8dc620ded02557bb28d5a18c501b877086))
* force release pr generation ([9a7398a](https://github.com/bustergreen-netizen/KunBox/commit/9a7398ad4fbc59fa431aecedb55f91796b9b8d93))
* harden import and recovery safety flows ([7a5b49c](https://github.com/bustergreen-netizen/KunBox/commit/7a5b49cb75d31b7cec6dabed38d0871441e1266a))
* https://github.com/roseforljh/KunBox/issues/55 ([4404960](https://github.com/bustergreen-netizen/KunBox/commit/440496068b37a3f6e9d6d69f45f6fabcb1341534))
* huawei ([b4ad894](https://github.com/bustergreen-netizen/KunBox/commit/b4ad8941688d31aaa3b6ad5ec550fa04a2d6b4dc))
* Hysteria2 port range format and code structure issues ([65fbea1](https://github.com/bustergreen-netizen/KunBox/commit/65fbea158e3d16118f9c476109db0769a3ec4095))
* Implement comprehensive node link parsing for various protocols, outbound configuration, startup management, and node detail display. ([4bb9174](https://github.com/bustergreen-netizen/KunBox/commit/4bb9174667519e00b3c4c7a497602b799c847151))
* Implement comprehensive node management, configuration settings, and related UI screens with data persistence and parsing capabilities. ([f9cfeca](https://github.com/bustergreen-netizen/KunBox/commit/f9cfecadb3d1e6f21e751c2af353b87ef72be75b))
* Implement core SingBox client functionality including VPN management, configuration, data persistence, and diagnostics. ([9e65bf4](https://github.com/bustergreen-netizen/KunBox/commit/9e65bf46f0f35dbebe32d7b16d684d0a13a5987d))
* Implement initial MainActivity and SingBoxApp setup, including UI, lifecycle management, and core feature integrations. ([c9b09cd](https://github.com/bustergreen-netizen/KunBox/commit/c9b09cdbda5f01610d2cf34cf7162915684ea9ae))
* Implement new screens for settings, traffic statistics, and routing configuration, supported by new UI components, data models, and localization. ([fd9f665](https://github.com/bustergreen-netizen/KunBox/commit/fd9f6652507fedd9951edd2d0a8a8711ef9cfe7f))
* implement outbound configuration normalization and add domain rules screen. ([dbdcfb5](https://github.com/bustergreen-netizen/KunBox/commit/dbdcfb5249c8fe26b24c3f572c017f5ea66fc9c8))
* Implement SingBox node configuration management with link parsing, exporting, and detail UI. ([b97c436](https://github.com/bustergreen-netizen/KunBox/commit/b97c436a9f019c8d3e9ee7bc76a3f787f90c6c4a))
* implement the initial SingBox Android client with core functionalities, UI, and data management. ([d4f3703](https://github.com/bustergreen-netizen/KunBox/commit/d4f37037df3aab04e1038c0b96339e52095ce5c2))
* internet op ([87c8238](https://github.com/bustergreen-netizen/KunBox/commit/87c8238dcf2d5b27f68bf33293adb291e88ada93))
* Introduce `ConfigRepository` and related components for comprehensive SingBox configuration, profile, and node management. ([cca6db5](https://github.com/bustergreen-netizen/KunBox/commit/cca6db5c7e3bdf69c8877e6138a9c99db37aec1f))
* Introduce SingBox core components, including configuration repository, service, and node parsing utilities. ([f6da4da](https://github.com/bustergreen-netizen/KunBox/commit/f6da4daefbbc3d4e1c08703ffde594782ca9e8d0))
* **ipc:** resolve UI stuck loading after Doze wake and proxy idle ([14d1713](https://github.com/bustergreen-netizen/KunBox/commit/14d171353071b3076122efcdefc9d7ce256a88bd))
* **ipc:** 修复从后台恢复后 UI 一直加载中的问题 ([806fa42](https://github.com/bustergreen-netizen/KunBox/commit/806fa42f911c13f022e75767ce99e2dceb5cb031))
* **ipc:** 修复后台恢复时UI卡住的问题 - 参考NekoBox实现 ([624361a](https://github.com/bustergreen-netizen/KunBox/commit/624361ac8348093f9fd00eae6767f3b9ee50cfe9))
* **ipc:** 应用返回前台时重置所有连接，修复 TG 等应用一直加载中的问题 ([3549747](https://github.com/bustergreen-netizen/KunBox/commit/35497474d0fec6031cafa1112d13e118885c3e07))
* **ipc:** 移除IPC广播中的Thread.sleep阻塞,优化后台恢复机制 ([7af318b](https://github.com/bustergreen-netizen/KunBox/commit/7af318bb2c32cbffb483316104857b475f1a6336))
* **latency-test:** resolve no available network interface error ([ef5b60c](https://github.com/bustergreen-netizen/KunBox/commit/ef5b60cbcb2aa8bae7e23140a8de4cd0a408effd))
* **latency:** enforce user-configured timeout for single node test ([9103dba](https://github.com/bustergreen-netizen/KunBox/commit/9103dba01b0f5ac7a1c68c9c358bca52ae804a53))
* **latency:** pass latency value directly in callback to fix race condition ([ac2e134](https://github.com/bustergreen-netizen/KunBox/commit/ac2e134db6c9c7c5febc2adcff95849cd5a579d2))
* **latency:** remove retry and fallback in batch latency test ([2deac44](https://github.com/bustergreen-netizen/KunBox/commit/2deac4457673cea8cd766868ce5ececc280b64b0))
* **latency:** resolve SS+ShadowTLS dependency for latency testing ([451e29e](https://github.com/bustergreen-netizen/KunBox/commit/451e29eded484e531a0861faab0043fbeac0bfea))
* **latency:** restore latency data when switching profiles ([67afd6f](https://github.com/bustergreen-netizen/KunBox/commit/67afd6f276d17574f5491fab5752a7fe33be3aaf))
* **latency:** support latency testing for nodes from all profiles ([020f82b](https://github.com/bustergreen-netizen/KunBox/commit/020f82b1b6c755af1e2ae0a578c323f9051ffd7d))
* **libbox:** adapt to new CommandServer API and fix service shutdown ([6b3df81](https://github.com/bustergreen-netizen/KunBox/commit/6b3df8176adfec224a03b180fb21880d8214237b))
* **lint:** 修复 detekt 报告的代码问题 ([901485c](https://github.com/bustergreen-netizen/KunBox/commit/901485c61c8e531dbadf1c81650335c6a757ab12))
* **memory:** optimize memory usage with LRU caches and static TypeTokens ([f25fa5e](https://github.com/bustergreen-netizen/KunBox/commit/f25fa5eea01a9343fd4208448dd1bb731e622769))
* **nav:** correct route mapping for Diagnostics and Logs pages ([cd18066](https://github.com/bustergreen-netizen/KunBox/commit/cd18066b55adcd8aae379e7e1438db7f85629ee1))
* **network:** add idle connection cleanup for TG image loading issue ([b6c54ef](https://github.com/bustergreen-netizen/KunBox/commit/b6c54efe70dda696c0f3b5efc8d504dec6d9f32c))
* **network:** add proactive recovery for faster foreground resume ([85764bd](https://github.com/bustergreen-netizen/KunBox/commit/85764bd46b5e2770d1a9703077eecae8c336f5f6))
* **network:** 优化WiFi与移动数据切换时的网络恢复机制 ([d7eebc2](https://github.com/bustergreen-netizen/KunBox/commit/d7eebc22b228c184d2dbfa663ff0b02036bae4bd))
* **network:** 收敛节点切换重启触发并增加前台恢复HARD兜底 ([f7dba7a](https://github.com/bustergreen-netizen/KunBox/commit/f7dba7a83446d9679b6bb8f0eb7ac8cd85bf9e62))
* **notification:** persist activeLabel to VpnStateStore for cross-process sync ([f7507ae](https://github.com/bustergreen-netizen/KunBox/commit/f7507ae62ca9119077d26d26f035c1c7afadd837))
* optimize network recovery for faster app reconnection after background ([f6b6c7a](https://github.com/bustergreen-netizen/KunBox/commit/f6b6c7a431aeeee87c2e416892859e83a0fa1cfa))
* **parser:** add wireguard and ssh link parsing support ([3494923](https://github.com/bustergreen-netizen/KunBox/commit/3494923947477f59bcffa927734bc11e90050dea))
* **parser:** handle empty string fields in Clash YAML hysteria2 nodes ([a4edefc](https://github.com/bustergreen-netizen/KunBox/commit/a4edefc3608b4a6bc62e6cfb75be9148d2ca4aef))
* **parser:** handle multiple links in clipboard import ([223c085](https://github.com/bustergreen-netizen/KunBox/commit/223c0852fd539ee5a7cc6150dd72062735032067))
* **parser:** 修复 vmess 链接无法从剪贴板导入的问题 ([882eeca](https://github.com/bustergreen-netizen/KunBox/commit/882eeca4b2861c8c15f09b01ba3b3d51acb32db5))
* **power:** add background power saving with configurable delay ([208d59a](https://github.com/bustergreen-netizen/KunBox/commit/208d59a1f1ae3cdbbba9d3c80d2cccda4164e09b))
* **power:** enable main process self-termination for power saving ([0b39d1f](https://github.com/bustergreen-netizen/KunBox/commit/0b39d1f70e0faf5e330ee7ef82c90d6742626920))
* preserve node sort preference after latency tests ([372f5af](https://github.com/bustergreen-netizen/KunBox/commit/372f5af83f197911a87fa2494376e023ef7f27c2))
* **profile:** 添加 DNS 预解析功能绕过 DNS 污染 ([3cd6095](https://github.com/bustergreen-netizen/KunBox/commit/3cd6095ae833beea7684021ddc5752227d1f8835))
* **recovery:** implement per-app connection state API for stale connection detection ([d8ad017](https://github.com/bustergreen-netizen/KunBox/commit/d8ad01718d6c0b3b57dee33071604647b6d278f2))
* remove periodic idle connection cleanup to prevent TG reconnection issues ([f7f34b6](https://github.com/bustergreen-netizen/KunBox/commit/f7f34b66a27a84cb34ce18140d27789fe155f55d))
* remove unused import and fix indentation ([37c31a8](https://github.com/bustergreen-netizen/KunBox/commit/37c31a89d0f9eb99aab9d77eb4579ce88f469fba))
* resolve IPC lifecycle and state synchronization issues ([c39c20c](https://github.com/bustergreen-netizen/KunBox/commit/c39c20c26a171e088d7c6615dc8a6950f7385e36))
* resolve lifecycle notification absence and IPC race conditions ([217da11](https://github.com/bustergreen-netizen/KunBox/commit/217da116dfe7cf72e897b13aa39728591affed90))
* **routing:** 优化规则集排序，特定服务规则优先于国家泛化规则 ([467360e](https://github.com/bustergreen-netizen/KunBox/commit/467360e1418b3b00150142c852efc730f7a9c681))
* **rulesets:** initialize defaults with toggleable downloads ([6d522ff](https://github.com/bustergreen-netizen/KunBox/commit/6d522ff25c7eeba18f0073762b3d363668d97927))
* **rulesets:** load geosite list via github tree ([79e06b4](https://github.com/bustergreen-netizen/KunBox/commit/79e06b4f1b0865f10fb7204ec98504d47cfd615e))
* **service:** notification bar node switch not working ([3dfb731](https://github.com/bustergreen-netizen/KunBox/commit/3dfb731d438376eb176245e0b314f6d071c76b3a))
* **service:** notification not dismissed when app removed from recents ([1dc9834](https://github.com/bustergreen-netizen/KunBox/commit/1dc983460b537444372366ceeba44f29ca71e4fd))
* **service:** 修复息屏后返回App时Telegram等应用一直加载的问题 ([137e64d](https://github.com/bustergreen-netizen/KunBox/commit/137e64d65dfaa8b7181dcd2990181f34c3ee8e7c))
* **settings:** 移除断线重连功能和UI ([bc2e5b8](https://github.com/bustergreen-netizen/KunBox/commit/bc2e5b8bc573e93fcaff264f597641f989028cf1))
* **shortcut:** node selection and VPN toggle not working from app shortcut ([1253563](https://github.com/bustergreen-netizen/KunBox/commit/12535633853cc1dcee0ea08188405d6d1672f10b))
* **sniff:** 将协议嗅探移至 inbound 层并启用 sniff_override_destination ([786d609](https://github.com/bustergreen-netizen/KunBox/commit/786d609475715074cf7d79e668110d1ca90ff2a9))
* speed up startup selection for profile route groups ([9f34cbd](https://github.com/bustergreen-netizen/KunBox/commit/9f34cbdd66f0013c342b0b9622ac0a8d2ec17023))
* stabilize vpn handover recovery ([2cfa995](https://github.com/bustergreen-netizen/KunBox/commit/2cfa9950b27c06309e3c669e4600cdb914cf958c))
* **startup:** filter invalid domains in DNS prewarm ([21f404f](https://github.com/bustergreen-netizen/KunBox/commit/21f404f93c6edfbd2a1eb065a301ce10e63de957))
* **startup:** prevent DoH URL from triggering DNS lookup timeout ([951987a](https://github.com/bustergreen-netizen/KunBox/commit/951987ac08df8aa04cb6c7fc435186e5e102a9e3))
* **subscription:** 修复取消导入后弹窗重复弹出及应用无法使用自身代理的问题 ([ef12cbb](https://github.com/bustergreen-netizen/KunBox/commit/ef12cbbf9166d2e87deed1f5d073ade70e38e3a0))
* **subscription:** 兼容订阅剩余/到期信息 ([8af42e1](https://github.com/bustergreen-netizen/KunBox/commit/8af42e1657ebf1dba2eb3a3d6edd56b13b9e58a5))
* **traffic:** 修复分流流量统计记录错误的问题 ([d8545df](https://github.com/bustergreen-netizen/KunBox/commit/d8545df1aa1f6ba48b60dfe050760a97fa5378b4))
* **traffic:** 完善流量统计功能 ([1c2e73e](https://github.com/bustergreen-netizen/KunBox/commit/1c2e73e59f146d0586012c45cf0d1049c2e2af29))
* **tun:** refine app list dialog quick select ([21c4c43](https://github.com/bustergreen-netizen/KunBox/commit/21c4c430db38b1a72cf2dca448a3269dcab4b92d))
* **ui:** add smooth crossfade animation for toggle icon transition ([4cdb257](https://github.com/bustergreen-netizen/KunBox/commit/4cdb2573bfcbedadee9401c3ef14b89a2d53d87d))
* **ui:** adjust ProfileCard layout weight for better text display ([480ca11](https://github.com/bustergreen-netizen/KunBox/commit/480ca11005d3e2ca996dab2c3aa4caae133bbded))
* **ui:** clean build warnings and consolidate stability notes ([3eee087](https://github.com/bustergreen-netizen/KunBox/commit/3eee087a49171f9ab80175f646cb9ad1caaa045c))
* **ui:** improve latency display placeholder ([73fb2a0](https://github.com/bustergreen-netizen/KunBox/commit/73fb2a09ff46672b91e63a5cfb8e9c536c5149bb))
* **ui:** InputDialog 输入框支持水平滚动 ([a63fcd1](https://github.com/bustergreen-netizen/KunBox/commit/a63fcd1ec7dfcb761b13cd02fe2abf234fdc6d05))
* **ui:** prevent gengar image clipping during crossfade animation ([39055b9](https://github.com/bustergreen-netizen/KunBox/commit/39055b9f5cfe1e0c624212bfb29ea77dad7d271b))
* **ui:** toggle fab visibility on scroll ([c42cff8](https://github.com/bustergreen-netizen/KunBox/commit/c42cff82b5f3c9e7e21c951ee0b617f54866799a))
* **ui:** 列表到底部时隐藏悬浮按钮 ([a232719](https://github.com/bustergreen-netizen/KunBox/commit/a23271949474e9b777c2872d64ea29069e9c00e6))
* **ui:** 应用分流仅显示仅允许列表中的应用并移除直连选项 ([05ff1da](https://github.com/bustergreen-netizen/KunBox/commit/05ff1da8acb967b3be6b1de88c53460200603180))
* ui控制参数 ([6745e0d](https://github.com/bustergreen-netizen/KunBox/commit/6745e0d65bf1d4f0a81b92bca73137e1fa7eef3b))
* **ui:** 调整 BigToggle 图像显示 ([8a53ced](https://github.com/bustergreen-netizen/KunBox/commit/8a53ced548eaf4cca29909706eb37c3a59bae928))
* **vpn:** add data plane connectivity verification and auto-recovery escalation ([4e66000](https://github.com/bustergreen-netizen/KunBox/commit/4e660001117d2a0fc86e1c1d35989cb647be395f))
* **vpn:** hot reload failure causes network loss ([2000436](https://github.com/bustergreen-netizen/KunBox/commit/20004364e3aa3e56a1d731f9a2e5f1762f70b335))
* **vpn:** per-app proxy settings not applied to TUN interface ([f3a9320](https://github.com/bustergreen-netizen/KunBox/commit/f3a93203861231fb83704c739687ec12c9b36d42))
* **vpn:** speed up stop flow and stabilize QS tile state ([a4238e7](https://github.com/bustergreen-netizen/KunBox/commit/a4238e7f01d1d6e2b0dd910213ead50e53ea606b))
* **vpn:** 修复VPN自动关闭和启动期间连接泄漏问题 ([9975a2e](https://github.com/bustergreen-netizen/KunBox/commit/9975a2ea6f4f8746f7f999477aff6ec864f059ba))
* **vpn:** 修复多个 VPN 启动和节点切换问题 ([f61fb11](https://github.com/bustergreen-netizen/KunBox/commit/f61fb11acc18bcb158698204e2393ce541a0ede7))
* **vpn:** 修复快速停止启动时端口未释放导致启动失败的问题 ([1fe74e7](https://github.com/bustergreen-netizen/KunBox/commit/1fe74e73d4fa90b8eccdadb95921a33715c0ef35))
* **vpn:** 修复息屏后 Telegram 等应用卡在加载中的问题 ([093ab71](https://github.com/bustergreen-netizen/KunBox/commit/093ab71863228341421a8e61f6aee6614ef21cb1))
* **vpn:** 修复热重载误判和端口释放问题 ([92cdfe9](https://github.com/bustergreen-netizen/KunBox/commit/92cdfe9276b21a59c69c74b460d8b48a5c8a2a5f))
* **vpn:** 全面加固 VPN 息屏保活机制,防止被系统杀死 ([0b39d09](https://github.com/bustergreen-netizen/KunBox/commit/0b39d0981024dd5be46fc6efa160eab2a41a8ffd))
* **vpn:** 启动前检测并处理外部 VPN，确保顺利接管 ([fa34d3b](https://github.com/bustergreen-netizen/KunBox/commit/fa34d3bedd62ea7660214d493d21acecda7b6c9b))
* **vpn:** 添加周期性健康检查防止 VPN 服务僵尸状态 ([843d4ec](https://github.com/bustergreen-netizen/KunBox/commit/843d4ecb413485663f72fd4c56a00c01f90cc2cb))
* **vpn:** 重启时刷新设置缓存以应用最新仅允许列表 ([589806e](https://github.com/bustergreen-netizen/KunBox/commit/589806e84f117784b429d7c49cc9a26645dced7c))
* 一些优化 ([a671207](https://github.com/bustergreen-netizen/KunBox/commit/a67120767789fa0e4ee949c676edca079dd854f9))
* 一些已知问题 ([2622695](https://github.com/bustergreen-netizen/KunBox/commit/2622695a3d9565d76b1007f9c3401ff7b5f87b61))
* 主题适配 ([234924c](https://github.com/bustergreen-netizen/KunBox/commit/234924cc7d537167d50e091c5a70abff23e5b2a1))
* 仅自动更新已应用的规则集 ([b678542](https://github.com/bustergreen-netizen/KunBox/commit/b6785421aae78c7ee9686efdfc67a4bd5f9e220d))
* 从 SagerNet API 同时获取 geosite 和 geoip 在线规则集 ([63fed50](https://github.com/bustergreen-netizen/KunBox/commit/63fed50304fa685a28a93eccf5ba0795b67b451d))
* 优化 ([567b554](https://github.com/bustergreen-netizen/KunBox/commit/567b5542ef48b785fb10fbf884f8474b8f19563f))
* 优化 SingBoxCore 代码注释和错误处理 ([d69bd8d](https://github.com/bustergreen-netizen/KunBox/commit/d69bd8dc5b4849179e17e1170e049098d286c1ec))
* 优化切网后的分流自动选路与连接收敛 ([c77a9bf](https://github.com/bustergreen-netizen/KunBox/commit/c77a9bf46ecfc8b5a7ff0ce948d020c71c3e669f))
* 优化延迟测试 ([a1fdcb4](https://github.com/bustergreen-netizen/KunBox/commit/a1fdcb47f221edc69228f6af080e9453b8be0251))
* 优化延迟测试 ([7b67a0a](https://github.com/bustergreen-netizen/KunBox/commit/7b67a0a26888099c0e06a66dae838cda10a3afb9))
* 优化构建配置和 ProGuard 混淆规则 ([046362a](https://github.com/bustergreen-netizen/KunBox/commit/046362af725fb7d87bcd9ea3e93a6365a15b0aca))
* 优化网络稳定 ([b03dd47](https://github.com/bustergreen-netizen/KunBox/commit/b03dd47ed083fcd9795ecf0baabb5066607d5a72))
* 优化订阅更新主链路与后台 DNS 预解析 ([7b0efae](https://github.com/bustergreen-netizen/KunBox/commit/7b0efae767244271434e04476548911f6d431e7e))
* 优化订阅更新等待与阶段反馈 ([553d930](https://github.com/bustergreen-netizen/KunBox/commit/553d930ab4335b339c3bc9be1377ca3a91d86e6d))
* 优化订阅更新逻辑 ([75fa6c5](https://github.com/bustergreen-netizen/KunBox/commit/75fa6c5d0ec4227f8e10b02b5734ec22e8e6036a))
* 优化重连、断连、热重载 ([95b3bfd](https://github.com/bustergreen-netizen/KunBox/commit/95b3bfd547be8ba80e091f096b0eb7049c6cef6e))
* 修复 DNS detour 与状态同步问题 ([dd84f6b](https://github.com/bustergreen-netizen/KunBox/commit/dd84f6b20cc054c4071fa2f8217d1a10135a2123))
* 修复 ECH 订阅节点 DNS 路由 ([c8ba34d](https://github.com/bustergreen-netizen/KunBox/commit/c8ba34d8a3660e65c618992c0dbabe7712ecb585))
* 修复 PROFILE/NODE 分流下 DNS detour 对齐 ([a99f047](https://github.com/bustergreen-netizen/KunBox/commit/a99f047bbd6abd99b62082d10dadd366ce77bcb4))
* 修复 VLESS PQC 节点 DNS 失败 ([2050958](https://github.com/bustergreen-netizen/KunBox/commit/20509585e9f4d9c71cb2717af9a687bf6696702b))
* 修复 VLESS WebSocket early data 导入 ([5d44109](https://github.com/bustergreen-netizen/KunBox/commit/5d441094552e7464049594f36c775fcd213b4c81))
* 修复 VMess http 导入与单节点测速误判 ([d7ea395](https://github.com/bustergreen-netizen/KunBox/commit/d7ea3952cb57b55a14edce205d27c7365f2faf19))
* 修复DNS规则分流异常 ([0f18dbe](https://github.com/bustergreen-netizen/KunBox/commit/0f18dbe23c82ba4da815c9447f59881f1eeb94ae))
* 修复TUIC禁用SNI配置冲突 ([c97e56d](https://github.com/bustergreen-netizen/KunBox/commit/c97e56d47b3694286dedbe4ca37aaa5748a368cd))
* 修复VMess http导入传输解析 ([891ed61](https://github.com/bustergreen-netizen/KunBox/commit/891ed6136f49d39020e52910116013fc73474738))
* 修复了一些已知问题 ([51f6994](https://github.com/bustergreen-netizen/KunBox/commit/51f6994d20f6edf52f71f8ed163383feced4fb15))
* 修复了热切换节点后 连接延迟的问题 ([894b2af](https://github.com/bustergreen-netizen/KunBox/commit/894b2affa8ce6a8a6ac53c3837b11b75b0d22f71))
* 修复云规则地址重复添加 raw.githubusercontent.com 前缀的问题 ([aed1dce](https://github.com/bustergreen-netizen/KunBox/commit/aed1dce1618e78a19d8103c04c99c04931fca717))
* 修复从后台恢复时卡在加载状态的问题 ([2a1363e](https://github.com/bustergreen-netizen/KunBox/commit/2a1363e9783a88abeaa219501d4c077a56d332bd))
* 修复从通知栏进入app后返回键需按两次才能退出的问题 ([1240f82](https://github.com/bustergreen-netizen/KunBox/commit/1240f8246a52b05189a33502577157873d223bb2))
* 修复出站 socket 物理网络绑定 ([24ca01b](https://github.com/bustergreen-netizen/KunBox/commit/24ca01b82b428f977d61de2f79acb29a1b1b0574))
* 修复测速与状态恢复相关问题并同步本地改动 ([e8583cc](https://github.com/bustergreen-netizen/KunBox/commit/e8583ccd0f30f4016b3556b4fe96dbeef785655f))
* 修复禁用SNI配置生成 ([d757e3b](https://github.com/bustergreen-netizen/KunBox/commit/d757e3bbaf24f82a0865af216864e5b99d6fd949))
* 修复节点选择状态未正确保存和显示的问题 ([1cdf3f7](https://github.com/bustergreen-netizen/KunBox/commit/1cdf3f7f69ff23dff50cb18ee748725d595e21b7))
* 修复规则集Hub添加云规则时URL重复拼接协议前缀的bug ([aa3d859](https://github.com/bustergreen-netizen/KunBox/commit/aa3d859cbff68dfc11eb6f345aaaff208a8e7e2f))
* 修复跨配置切换节点时无法上网的问题 ([ab3ba67](https://github.com/bustergreen-netizen/KunBox/commit/ab3ba67ac8c0deea104f1ee2cde16d7250ec09da))
* 修复运行时DNS与恢复异常 ([2598ae3](https://github.com/bustergreen-netizen/KunBox/commit/2598ae3bc6e402d9734382ec23764f8b73974ccd))
* 修复首次前台误触发DEEP恢复导致连接卡住 ([ed7a774](https://github.com/bustergreen-netizen/KunBox/commit/ed7a774c073c715fa58b9bb579a6976502e1fe3c))
* 修正 urltest 运行时配置字段回写 ([5aa26bf](https://github.com/bustergreen-netizen/KunBox/commit/5aa26bffdce3b957faa6132d384555a00fca0956))
* 修正订阅 HTML 误判导致的节点丢失 ([8fcd8f0](https://github.com/bustergreen-netizen/KunBox/commit/8fcd8f0cb2126b22aba613c1cde7330bfaa1adf9))
* 全局禁用endpoint_independent_nat和auto_route ([2aa437e](https://github.com/bustergreen-netizen/KunBox/commit/2aa437ecba131769cb32b2f94a84bdcb4206a4a2))
* 关于应用里加上app本体及singbox的版本号 ([2c6bd61](https://github.com/bustergreen-netizen/KunBox/commit/2c6bd61777b3f61d615ca4496ff6358539c9109b))
* 内核同步官方1.13.4 ([f1c8ac9](https://github.com/bustergreen-netizen/KunBox/commit/f1c8ac99fb8d54033be149dc478d3c981bccf74e))
* 内核更新 ([a0ce160](https://github.com/bustergreen-netizen/KunBox/commit/a0ce160e60c3414755d64fedece23e614bd67bd1))
* 内核更新、bug修复 ([199f481](https://github.com/bustergreen-netizen/KunBox/commit/199f4814148446f2d1f316df2efa81eaae5ffce1))
* 删除组逻辑 ([5aa7021](https://github.com/bustergreen-netizen/KunBox/commit/5aa702157adf0cfbb92aec1eb810105ca96e990b))
* 刷新 ([12c2a06](https://github.com/bustergreen-netizen/KunBox/commit/12c2a061456bea16b5fdaa45aadff3dfc820cbbb))
* 只读节点信息 ([4c0976b](https://github.com/bustergreen-netizen/KunBox/commit/4c0976b9e2eb3f8305cb91a32bd2b97ecce55fd5))
* 可能解决了一些闪退的问题 ([ef5e728](https://github.com/bustergreen-netizen/KunBox/commit/ef5e7283710ac2839548fe1bfe9a99303c8304f3))
* 同步singbox官方最新版本内核 ([462d30f](https://github.com/bustergreen-netizen/KunBox/commit/462d30f00486811121644b623d7ec4d0f827aba1))
* 同步官方内核 ([2949531](https://github.com/bustergreen-netizen/KunBox/commit/2949531c98a01f4dfd20cd6c35a66ad6d4d51096))
* 同步官方内核 ([7d6c376](https://github.com/bustergreen-netizen/KunBox/commit/7d6c3764cb5c4d5fa05c81ed13d6dc172d6dd7a3))
* 同步官方内核 ([f054302](https://github.com/bustergreen-netizen/KunBox/commit/f054302a5c90c74e9ff95ae52ab0929b844e363e))
* 同步官方内核、一些优化 ([060b4b9](https://github.com/bustergreen-netizen/KunBox/commit/060b4b94d86aae0b6689450b05faecba193b49ea))
* 同步官方最新内核 ([f9b112c](https://github.com/bustergreen-netizen/KunBox/commit/f9b112c9baf7dc54ee3e9c57a652da323bc97e5a))
* 在配置导入入口接通自定义配置弹窗 ([cb35298](https://github.com/bustergreen-netizen/KunBox/commit/cb352983a12ef86667f8d77819fef9f34255787c))
* 基于上一个版本的一些小补丁 ([e26ba3e](https://github.com/bustergreen-netizen/KunBox/commit/e26ba3e72520f6926432f168d22ec93421791191))
* 增加日志开关 ([9beb8ff](https://github.com/bustergreen-netizen/KunBox/commit/9beb8ff72f75911b04fef7e0335e9a4c650c53ea))
* 增强稳定性 ([223c19f](https://github.com/bustergreen-netizen/KunBox/commit/223c19f2f004701afef7988c8f9a2358c026d07e))
* 多处优化 ([189e8c9](https://github.com/bustergreen-netizen/KunBox/commit/189e8c9077b167f9d6ca10b3869aff544af48bca))
* 多处变动 ([9299dcb](https://github.com/bustergreen-netizen/KunBox/commit/9299dcb9159b8643e6aca234f4a723070d202b92))
* 多节点闪退 ([d0d26e5](https://github.com/bustergreen-netizen/KunBox/commit/d0d26e5a7d9ce3a386107a91b771976c16f8ccab))
* 大量重构 ([8b99ba1](https://github.com/bustergreen-netizen/KunBox/commit/8b99ba1ac1602164e533968bac7f3584e6002b5b))
* 实时显示上传和下载速度 ([0af613e](https://github.com/bustergreen-netizen/KunBox/commit/0af613ee7a5aa3afb2b2d4140ed0c2de11f601cd))
* 实现配置管理，加号按钮里面本地文件和扫描二维码 ([ec24666](https://github.com/bustergreen-netizen/KunBox/commit/ec24666f53992d0137469513f520f3db9275fb0f))
* 尝试修复fakeip的问题 ([3ffc626](https://github.com/bustergreen-netizen/KunBox/commit/3ffc6268fb68b220d691d398e0ca4dc24091668e))
* 工作流bug ([6f0a30b](https://github.com/bustergreen-netizen/KunBox/commit/6f0a30b2b9d4b8dea0d401d34411ae3a0fbfdaed))
* 常规优化 ([c46a883](https://github.com/bustergreen-netizen/KunBox/commit/c46a8830d2fe2112bb37a53735026dc78034d5ab))
* 常规优化 ([5a8f38d](https://github.com/bustergreen-netizen/KunBox/commit/5a8f38d056e2b0eaa26fd4a12cba6636cf7d5b2b))
* 应用官方最新规范 ([8c1610d](https://github.com/bustergreen-netizen/KunBox/commit/8c1610d65e24960e40d77498a80cb7503be5bb14))
* 底部导航切换过渡动画、磁贴按钮 ([1a4f92c](https://github.com/bustergreen-netizen/KunBox/commit/1a4f92c06b4b104088149d52bb223894305c66b3))
* 很吊 ([def14cf](https://github.com/bustergreen-netizen/KunBox/commit/def14cf7312207d09e74142a6b30ddcd7d8e4079))
* 性能优化 ([4e3cfee](https://github.com/bustergreen-netizen/KunBox/commit/4e3cfee07cfb44ad8b66a291df9561b6cbc729bc))
* 收敛外部 VPN revoke 后的停止与恢复状态 ([9bfd67b](https://github.com/bustergreen-netizen/KunBox/commit/9bfd67b5043a241810d669b236e8137aafaa9a72))
* 新内核 ([a1bcad1](https://github.com/bustergreen-netizen/KunBox/commit/a1bcad131ffc42bf68a7caf0f578a6c23f588893))
* 新增 URL Scheme 深度链接支持和问题修复文档 ([5432a6b](https://github.com/bustergreen-netizen/KunBox/commit/5432a6b948e705bc49fec833e626c521f612a829))
* 新增应用启动时清理遗留临时数据库文件的功能 ([1bf5a2a](https://github.com/bustergreen-netizen/KunBox/commit/1bf5a2a6f27b32a7be22fb7af9c15e36223756e7))
* 新增项目文档索引和优化指南 ([108d3b9](https://github.com/bustergreen-netizen/KunBox/commit/108d3b9a1fcb3fa891dff3fcd9686d4f5358b537))
* 智能识别 GeoIP 规则类型，防止 IP 规则错误添加到 DNS 层 ([1709180](https://github.com/bustergreen-netizen/KunBox/commit/17091802997956334f2a48d45188448c502b8ce5))
* 更新 planning-with-files submodule 和临时修复代码 ([dffd1e9](https://github.com/bustergreen-netizen/KunBox/commit/dffd1e90c5b92f5ca27e3f103df7d645a39a5dad))
* 更新内核、重新支持Vless-xhttp-reality-enc协议节点 ([48e8d80](https://github.com/bustergreen-netizen/KunBox/commit/48e8d80009c5b299f68cd07090c6e7f85f9ebc32))
* 更新镜像、添加导入导出数据功能 ([a20a115](https://github.com/bustergreen-netizen/KunBox/commit/a20a115986e7d0ef646dca830a4788135a4c3433))
* 添加内置 geoip 规则集支持，修复搜索 geoip 无结果的问题 ([1f90f94](https://github.com/bustergreen-netizen/KunBox/commit/1f90f94b3b8620b13a9e59551e373b1fed3fcd90))
* 清理不必要的临时文件和 planning-with-files ([04f9670](https://github.com/bustergreen-netizen/KunBox/commit/04f96701c1f8f8c4fee5422cdecb9f08aa459776))
* 清理冗余调试日志以提升性能和可读性 ([dd3a404](https://github.com/bustergreen-netizen/KunBox/commit/dd3a404a0301ed2a8be4550a9b3ef196e34b4726))
* 清理废弃的构建脚本并优化 libbox 构建流程 ([de78f57](https://github.com/bustergreen-netizen/KunBox/commit/de78f576f6e998a326cc9a0d3d55dbcbc84990c4))
* 磁贴启动VPN使用错误节点，auto-failover不应持久化节点选择 ([39dda31](https://github.com/bustergreen-netizen/KunBox/commit/39dda315be3a53fd7ed6d434919b4f415bbf5cac))
* 移除内核版本管理功能并优化核心服务 ([931e169](https://github.com/bustergreen-netizen/KunBox/commit/931e1697574444ecf59c565b402aac169a5b7d93))
* 移除已过时的 bugfix 文档 ([2e80582](https://github.com/bustergreen-netizen/KunBox/commit/2e8058272a2c113347d9a196c8af7c621734ee78))
* 移除节点名称自动添加协议后缀 ([2bd0423](https://github.com/bustergreen-netizen/KunBox/commit/2bd0423a97ccb72c40b725c5df226b1fc98710f7))
* 稳定网络 ([2bcd87d](https://github.com/bustergreen-netizen/KunBox/commit/2bcd87d8e21d210704662f487fe0849450d6fea2))
* 统一 TUN MTU 默认值并移除冗余日志 ([7af9639](https://github.com/bustergreen-netizen/KunBox/commit/7af96395f66d20b3c79a7d105eb5bbcf9eab643e))
* 统一双栈 IP 模式与 DNS 路由 ([4935a93](https://github.com/bustergreen-netizen/KunBox/commit/4935a93db0b4b7c37dc305f1190f598a7000763f))
* 自定义配置顺序 ([9e4e665](https://github.com/bustergreen-netizen/KunBox/commit/9e4e6656f396e5f9aedcc4fcc5816722dafb138a))
* 补充VMess http导入回归验证 ([fbf2fd3](https://github.com/bustergreen-netizen/KunBox/commit/fbf2fd31740d45d3ac1c425545a3208f418a4022))
* 补充订阅更新阶段状态展示 ([4115473](https://github.com/bustergreen-netizen/KunBox/commit/4115473d636a2438d207846b4584b7966535cfa6))
* 补齐 Clash YAML 导入 xhttp encryption 映射 ([ef661b0](https://github.com/bustergreen-netizen/KunBox/commit/ef661b0878f7154c28b7c767a9a0a42aea474e5e))
* 补齐 fakeip DNS server 的地址段配置 ([3414cf7](https://github.com/bustergreen-netizen/KunBox/commit/3414cf7dd4194e7a12dd31a72da92f96372f71c9))
* 补齐自定义配置的数据创建链路 ([53e99f5](https://github.com/bustergreen-netizen/KunBox/commit/53e99f5f10636ac5ba4a06ea4074021366429f60))
* 规则集定时自动更新 ([b1803b4](https://github.com/bustergreen-netizen/KunBox/commit/b1803b40ab9590ebb5d358ac6219ed16a6a72898))
* 规则集页面补上和配置页一致的平滑拖拽与松手归位动画 ([e1a2d0a](https://github.com/bustergreen-netizen/KunBox/commit/e1a2d0ac29ad1d2fb8f49a541c70429589885149))
* 解决 VPN 快速重启导致的网络接口不同步问题 ([0732fd6](https://github.com/bustergreen-netizen/KunBox/commit/0732fd607529d3d28522320a698f5bab67ea10dd))
* 解析器识别 anytls 节点 ([742cd95](https://github.com/bustergreen-netizen/KunBox/commit/742cd95d84e429df2f22ffc7ebab552b7f63fb27))
* 订阅定时更新 ([0363898](https://github.com/bustergreen-netizen/KunBox/commit/0363898cc9377c9f4cd6042a74f01cfbcc24c94a))
* 部分订阅节点丢失 ([ecb9f74](https://github.com/bustergreen-netizen/KunBox/commit/ecb9f745eda3443e02a25014ec6e626c195504a3))
* 针对分流的一些修复 ([5492fb7](https://github.com/bustergreen-netizen/KunBox/commit/5492fb7c97a4d0fdd3642d0e6e1f5b03e7bbd44f))
* 长按功能 ([276fc8e](https://github.com/bustergreen-netizen/KunBox/commit/276fc8e3589660a9e19573f23c4a5678fcac13dd))
* 长按图标出现的操作选项 ([db340c0](https://github.com/bustergreen-netizen/KunBox/commit/db340c095572ce3cdf5cd6414ef903a21b445bfa))
* 限制运行日志采集到调试模式 ([ddecd23](https://github.com/bustergreen-netizen/KunBox/commit/ddecd23e885c29dd5f33cdb4e0db1d0559f11100))
* 首页设计 ([3a86145](https://github.com/bustergreen-netizen/KunBox/commit/3a86145d750e62abb38de4a0f6521ba0efc0cb51))


### Performance Improvements

* implement 4 performance optimizations ([465a7ee](https://github.com/bustergreen-netizen/KunBox/commit/465a7eea13a46c2a8a6448dfa82acc29d9d30b69))
* **network:** optimize throughput and enable GSO ([ed83201](https://github.com/bustergreen-netizen/KunBox/commit/ed832018a458ed55de3a627f0fda47ef457f4b1e))
* **repository:** optimize node import performance and add Kryo serialization ([29f8268](https://github.com/bustergreen-netizen/KunBox/commit/29f8268ee3d93492684fd510e648ac3b4df09bdf))
* **repository:** parallelize node extraction and subscription updates ([a86228e](https://github.com/bustergreen-netizen/KunBox/commit/a86228e6994b0cf6662fd3d359473e53434519de))
